...
if animation_hit_frame(1) {
	...
	var _damage = 1;   
	var _knockback = 4;
	var _hitbox = create_hitbox(s_sword_effect_hitbox,x,y,_angle,_frame,[o_enemy,o_flower_p],_damage,_knockback);
	
	var _sword_effect = instance_create_layer(x,y,P,o_sword_effect);
